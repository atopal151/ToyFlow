...
class _PakaEditScreenState extends State<PakaEditScreen> {
  ...
  String? _selectedDonumBoyut; // Seçilen  boyut
  String? _selectedDonumRenk; // Seçilen  renk
  String? _selectedDonumMalzeme; // Seçilen ürün
  String? _selectedDonumAksesuar; // Seçilen aksesuar
  //Fire stok
...
// Boyut seçme dropdown
            ...
            DropdownSelector(
              hintText: 'Aksesuar',
              items: _aksesuar,
              selectedValue: _selectedDonumAksesuar,
              onChanged: (String? newValue) {
                setState(() {
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      if (_selectedDonumMalzeme!.isEmpty ||
                          ...
                          _selectedDonumAksesuar!.isEmpty ||
